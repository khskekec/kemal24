...
const DailyHourlyAvgHeatmap = ({}) => {
  ...
  const getData = async () => setData((await axios.get('/bloodsugar/daily-hourly-avg')).data);
  ...
  return <HeatMap {...commonProperties} data={Object.values(transformed)}
                  padding={2}
                  enableGridX={true}
